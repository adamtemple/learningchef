...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "adamtemple-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/adamsorganisation"
  #   chef.validation_client_name = "adamsorganisation-validator"
  #   chef.validation_key_path = ".chef/adamsorganisation-validator.pem"
  # end
end
